...
const subjectsConfig = [
    { id: 'mgp_1', subj: "Міжнародне гуманітарне право", group: "БМПм-25 (Денна)", lecTotal: 20, pracTotal: 20, term: "Екзамен" },
    { id: 'mgp_2', subj: "Міжнародне гуманітарне право", group: "зБМПм-25 (Заочна)", lecTotal: 2, pracTotal: 12, term: "Екзамен" },
    { id: 'popd_1', subj: "Правові основи проф. діяльності", group: "ФВС-22 (Денна)", lecTotal: 16, pracTotal: 14, term: "Залік" },
    { id: 'popd_2', subj: "Правові основи проф. діяльності", group: "зФВС-21 (Заочна)", lecTotal: 2, pracTotal: 4, term: "Залік" },
    { id: 'ppp_1', subj: "Публічно-приватне партнерство", group: "ПУА-24 (Денна)", lecTotal: 4, pracTotal: 4, term: "Залік" },
    { id: 'ppp_2', subj: "Публічно-приватне партнерство", group: "зПУА-24 (Заочна)", lecTotal: 2, pracTotal: 4, term: "Залік" },
    { id: 'ppp_3', subj: "Публічно-приватне партнерство", group: "зБМП-21 (Заочна)", lecTotal: 2, pracTotal: 8, term: "Залік" },
    { id: 'mzpl_1', subj: "Міжнародний захист прав людини", group: "зБМП-22 (Заочна)", lecTotal: 4, pracTotal: 14, term: "Екзамен" },
    { id: 'dp_1', subj: "Договірне право", group: "МОм(д)-25, зМОм-25", lecTotal: 10, pracTotal: 8, term: "Залік" }
];
